window.onload = function () {
    ...
    var alphabetBoard = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h',
    ...
    play = function () {
      ...
      chosenCategory = puzzleWords[Math.floor(Math.random() * puzzleWords.length)];
    ...
    // Hint
      ...
      var catagoryIndex = puzzleWords.indexOf(chosenCategory);
